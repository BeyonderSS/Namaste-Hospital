...
const Room = () => {
  ...
  return (
    ...
    <div className="bg-gray-100 h-screen text-blue-600 font-bold p-8">
      <h1 className="text-3xl mb-8">Meeting Code : {roomName}</h1>
      <div className="flex flex-wrap gap-4 justify-center">
        <video className="w-auto  md:h-[600px]" autoPlay ref={userVideoRef} />
        <video className="w-auto  h-52" autoPlay ref={peerVideoRef} />
      </div>
